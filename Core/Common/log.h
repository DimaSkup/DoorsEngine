...
public:
	...
	//inline static std::string GetLogMsg(const int idx) { return (idx < currLogMsgNum_) ? msgs_[idx] : ""; }
	//inline static int GetLastMsgIdx() { return currLogMsgNum_ - 1; }
...
private:
	...
	//static std::string msgs_[1000];
	//static int currLogMsgNum_;
