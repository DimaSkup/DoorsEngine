	...
	const std::string& path)
{
	...
	catch (const std::bad_alloc& e)
	{
		...
		return ModelStorage::INVALID_MODEL_ID;
	}
...
ModelID ModelsCreator::Create(ID3D11Device* pDevice, const ModelType type)
{
	...
	const MeshGeosphereParams& params)
{
	...
	model.type_ = ModelType::GeoSphere;
...
ModelID ModelsCreator::CreateSkull(ID3D11Device* pDevice)
{
	...
	MeshMaterial& mat = model.materials_[0];
	...
	const MeshCylinderParams& params)
{
	...
	model.type_ = ModelType::Cylinder;
