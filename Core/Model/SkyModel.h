...
public:
	...
	inline const XMFLOAT3& GetColorCenter()  const { return colorCenter_; }
	inline const XMFLOAT3& GetColorApex()    const { return colorApex_; }
...
private:
	const ModelType           type_ = ModelType::Sky;
