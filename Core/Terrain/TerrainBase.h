...
struct TerrainConfig
{
    ...
    // LODs params (where we switch more detailed lod to less detailed)
    int distToLod0 = 0;
    int distToLod1 = 0;
    int distToLod2 = 0;
    int distToLod3 = 0;
    ...
    float specular[3]{ 0.0f };
    float glossiness = 0.0f;
    float reflect[4] { 0.0f };
};
...
public:
    ...
    //--------------------------------------------------------------
    uint8 GetNatureDensityAtPoint(const float x, const float z) const;
