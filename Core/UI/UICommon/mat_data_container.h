...
struct MaterialData
{
    ...
    RsID  currRsId = 0;      // current raster state of this material
    BsID  currBsId = 0;      // current blend state of this material
    DssID currDssId = 0;     // current depth-stencil state of this material
};
