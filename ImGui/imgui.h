...
struct ImFontConfig
{
    ...
    unsigned int    FontBuilderFlags;       // 0        // EngineConfigs for custom font builder. THIS IS BUILDER IMPLEMENTATION DEPENDENT. Leave as zero if unsure.
