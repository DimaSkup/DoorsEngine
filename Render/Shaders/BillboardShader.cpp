...
{
    CAssert::True(materials, "input ptr to materials arr == nullptr");
    CAssert::True(positions, "input ptr to positions arr == nullptr");
    CAssert::True(sizes,     "input ptr to sizes arr == nullptr");
    ...
    const int numBillboards)
{
    ...
    try
    {
        ...
        CAssert::True(pInstancedBuffer_, "ptr to instanced buffer == nullptr (you have to initialize it!)");
#endif
