//==================================================================================
// Desc:  a pixel shader for rendering of metallic surfaces
//==================================================================================
...
float4 PS(PS_IN pin) : SV_Target
{
    ...
    // modulate with late add (reflection + light)
    float4 litColor = (material.reflect * reflectionColor) +   
	                  (diffTex * (ambient + diffuse) + spec);
