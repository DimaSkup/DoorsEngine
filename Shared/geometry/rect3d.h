...
public:
    ...
    void UnionPoint(const Vec3& p);
    void BuildAABB(const Vec3* points, const int numPoints);
    ...
    bool IsPointInRect(const float x, const float y, const float z) const;
    bool IsPointInRect(const Vec3& point) const;
