/**********************************************************************************\
    ...
    ******     ******    ******   **    **  ********
    ...
    Desc:     implementation of different helpers to make works
              with DirectXMath a bit easier
\**********************************************************************************/
...
//---------------------------------------------------------
// return convert quaternion into roll/pitch/yaw
//---------------------------------------------------------
...
//---------------------------------------------------------
// Desc:  get inverse transpose matrix of input matrix
//---------------------------------------------------------
DirectX::XMMATRIX MathHelper::InverseTranspose(const DirectX::CXMMATRIX& M)
{
